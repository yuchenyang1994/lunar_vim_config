...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lsp_signature.nvim', 'indent-blankline.nvim', 'gitsigns.nvim', 'Comment.nvim', 'todo-comments.nvim', 'nvim-bqf'}, { event = "BufRead *" }, _G.packer_plugins)]]
