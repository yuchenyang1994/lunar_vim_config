...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'Comment.nvim', 'todo-comments.nvim', 'nvim-bqf', 'lsp_signature.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
