...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    after_files = { "/Users/user/.local/share/lunarvim/site/pack/packer/opt/Comment.nvim/after/plugin/Comment.lua" },
  ...
  ["tabby.nvim"] = {
    ...
    loaded = true,
    path = "/Users/user/.local/share/lunarvim/site/pack/packer/start/tabby.nvim",
