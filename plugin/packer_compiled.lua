...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'Comment.nvim', 'lsp_signature.nvim', 'todo-comments.nvim', 'indent-blankline.nvim', 'nvim-bqf'}, { event = "BufRead *" }, _G.packer_plugins)]]
