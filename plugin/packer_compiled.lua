...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'nvim-bqf', 'lsp_signature.nvim', 'gitsigns.nvim', 'todo-comments.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
